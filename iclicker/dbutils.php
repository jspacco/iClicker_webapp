...
function createAnswers($conn, $student_id, $section_id) {
	...
	$query = "
		...
		SELECT s.session_id, s.session_tag, s.session_date, r.student_id, count(*) 
		AS answers
...
function createCorrectCounts($conn, $student_id, $section_id) {
	...
	$query = "
		...
		SELECT s.session_id, s.session_date, s.session_tag, r.student_id, count(*) 
		AS numcorrect
...
function createQcounts($conn, $section_id) {
	...
	$query = "
		...
		SELECT s.session_id, s.session_tag, s.session_date, count(*) 
		AS count
